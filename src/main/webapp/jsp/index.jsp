...
<head>
    ...
    <meta charset="UTF-8">
    <base target="_self">
    <link rel="stylesheet" href="${paths}/css/index.css" />
    <script type="text/javascript" src="${paths}/js/jquery-1.11.2.min.js"></script>
...
<header id="fastTop" class="header">
    <div class="search_box">
            <span class="logo">
                <a href="">
                    <img src="${paths}/images/logo.jpg"></a>
            </span>
        <div class="keyword">
        ...
        <c:if test="${not empty sessionScope.user }">
            ...
            &nbsp;&nbsp;<a href = "${paths}/user/logout"><font color="blue">[退出登陆]</font></a>
        </c:if>
...
<div class="banner">
    <div class="banner-content">
        <ul class="banner-left">
            ...
            <a href="${paths}/hospital/hospitalList">
                <li>查找医院</li>
            </a><a href="${paths}/doctor/doctorList">
            <li>查找医生</li>
        </a>
        </ul>
    </div>
...
<div class="carousel-infos">
    <div id="slideBox" class="slideBox">
        ...
        <div class="bd">
            <ul>
                <li style="display: none;"><a href="#" target="_blank"><img src="${paths}/images/banner1.jpg"></a></li>
                <li style="display: none;"><a href="#" target="_blank"><img src="${paths}/images/banner2.jpg"></a></li>
                <li style="display: list-item;"><a href="#" target="_blank"><img src="${paths}/images/banner3.jpg"></a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="find-hospital">
                <h3>
                    ...
                    <a id="hos-more" href="${paths}/hospital/hospitalList" target="_blank"><span class="more-hos">查看全部<img src="${paths}/images/arrow_normal.png"></span></a></h3>
                <div class="content" id="cityTab">
                    <ul>
                        <c:forEach items="${hospitalTop3}" var="hospital">

                        <li class="hospital-detail"><a href="${paths}/hospital/detail/${hospital.hid}" target="_blank">
                            <img src="${hospital.image}" alt="${hospital.hname}" width="230" height="120"></a>
                            <p class="hospital-name"><a href="${paths}/hospital/detail/${hospital.hid}" title="${hospital.hname}" target="_blank">
                                <span class="span-name">${hospital.hname}</span></a>
                            <i class="star-right star-light star-fixed"></i><i class="star-right star-light star-fixed"></i>
                                <i class="star-right star-light star-fixed"></i><i class="star-right star-light star-fixed"></i>
                    ...
                    <ul class="hospital-info">
                        <c:forEach var="hospital" items="${hospitalList}">
                            <li><a href="${paths}/hospital/detail/${hospital.hid}" title="${hospital.hname}" target="_blank"><span class="span-hospital ">${hospital.hname}</span></a>
            ...
            <div class="hot-department">
                <h3>热门科室</h3>
                <div class="content" style="width: 100%;height: 300px;">
                    <ul>
                        <li class="first-info">
                            <div class="dep-left"><a target="_self" class="dep-title" href="${paths}/doctor/doctorList?degrade=1"><b>一级科室</b></a></div>
                            <div class="dep-right">
                                <c:forEach var="list" items="${deptList1}">
                                    <a class="dep-item dep-light" href="${paths}/doctor/doctorList?deid=${list.deid}" target="_self" title="${list.dename}">${list.dename}</a>
                                </c:forEach>
                            </div>
                        </li>
                        <li class="first-info">
                            <div class="dep-left"><a target="_self" class="dep-title" href="${paths}/doctor/doctorList?degrade=2"><b>二级科室</b></a></div>
                            <div class="dep-right">
            ...
            <div id="excel-doctor-div" class="excel-doctor">
                <h3>名师名医<a href="${paths}/doctor/doctorList" target="_blank"><span>更多名医<img src="${paths}/images/arrow_normal.png"></span></a></h3>
                <div class="content slideBox2">
                    <div id="pre-arrow" class="pre-arrow prev">
                        <img data-gray="images/pre_disable.png" data-srchover="images/pre_hover.png" data-src="images/pre_normal.png" src="${paths}/images/pre_disable.png">
                    </div>
                    <div class="doctail-detail bd">
                        <ul id="dictor-list-ul">
                            <c:forEach var="doctor" items="${doctorList}">
                                <li class="doctor-first" style="background-color: rgb(249, 249, 249);">
                                    <a href="${paths}/doctor/detail/${doctor.did}" >
                                    ...
                                    <p class="btn-appoint"><a href="${paths}/doctor/detail/${doctor.did}"><span style="border-color: rgb(1, 151, 241); color: rgb(255, 255, 255); background-color: rgb(1, 151, 241);">一键预约</span></a></p>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
                    <div id="next-arrow" class="next-arrow next">
                        <img data-gray="images/arrow_disable.png" data-srchover="images/arrow_hover.png" data-src="images/arrow_normal.png" src="${paths}/images/arrow_disable.png">
                    </div>
                </div>
            </div>
            <!-- END优质医生-->
            ...
            <div class="res-info">
                ...
                <div class="num-info">
                    ...
                    <div class="img-container">
                        <img src="${paths}/images/number_bg.png" class="number-bg "><i class="num">${doctorSize}</i>
                    </div>
                ...
                <div class="num-info">
                    ...
                    <div class="img-container">
                        <img src="${paths}/images/number_bg.png" class="number-bg "><i class="num">${appointmentSize}</i>
                    </div>
            ...
            <div class="news">
                ...
                <ul class="news-list">
                    <c:forEach items="${hospitalList}" var="hospital">
                        <li>
                            <a href="${paths}/hospital/detail/${hospital.hid}" target="_blank">
                                    ${hospital.hname}
                            </a>
    ...
    <div class="footer-con">
        <div class="footer-info-url">
            <dd class="fo-link">
                ...
                <a href="#" target="_blank"><span>©2020  &nbsp;&nbsp;隐私条款</span></a>
            </dd>
        </div>
    </div>
</footer>
...
<script src="${paths}/js/jquery-1.11.2.min.js"></script>

<script src="${paths}/js/uni_login_wrapper.js"></script>

<script src="${paths}/js/jquery.SuperSlide.2.1.1.js"></script>
