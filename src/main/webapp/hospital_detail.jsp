...
<html lang="zh_CN">
<head>
    <title>医院自助预约hospital_detail.jsp</title>
    <meta charset="UTF-8">
...
<div class="wrap">
    ...
    <article class="broad" style="border-bottom: none; margin-bottom: 0px;">
        ...
        <div class="ct">
            ...
            <p class="depics"><b class="sq">4.</b>就诊前一天16:00前，到“我的医院自助预约”&gt;“我的预约”，可取消预约</p>
    ...
    <article class="broad" style="margin-bottom: 0px;">
        ...
        <div class="ct">
            <p class="depics"><b class="sq">1.</b><a target="_blank" href="#">医院自助预约是什么？</a></p>
